...
st.success('''The vehicle market is quite active in World.
 Therefore predicting vehicle prices is highly variable. In this Project, 
...
if st.checkbox("About"):
    st.markdown("""The vehicle market is quite active in World.
 Therefore predicting vehicle prices is highly variable. In this Project, 
 machine learning models are compared and chosen the best model for price prediction.
    """)
    st.markdown("""The training model was carried out by dividing the models by vehicle brands instead of a single 
     big model training for both effective optimization processes and better use of computer power and time. 
     Approximately 100.000 data with 12 features were used in training. The machine learning models  are:""")
